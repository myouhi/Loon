...
插件列表在页面下方，可直接点击链接一键添加，不要复制链接手动安装。
...
[配置文件](https://raw.githubusercontent.com/myouhi/Loon/master/loon.conf)      [图标仓库](https://raw.githubusercontent.com/myouhi/Loon/master/icon/icon.json)
